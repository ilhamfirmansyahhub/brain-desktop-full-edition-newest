            ...
            Row {
                ...
                Rectangle {
                    ...
                    Row {
                        ...
                        Text { text: dRow.isConnected ? "Connected" : "Connect"; font.pixelSize: 11; font.weight: Font.Medium; anchors.verticalCenter: parent.verticalCenter; color: "#FFFFFF"; Behavior on color { ColorAnimation { duration: 120 } } }
                    }
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Text { id: pairLbl; anchors.centerIn: parent; text: "Pair"; font.pixelSize: 11; font.weight: Font.Medium; color: "#FFFFFF" }
                ...
                Column {
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            Behavior on color { ColorAnimation { duration: 100 } }
                            Text { anchors.centerIn: parent; text: "Pair"; font.pixelSize: 11; font.weight: Font.Medium; color: "#FFFFFF" }
        ...
        Column {
            ...
            Rectangle {
                ...
                Row { id: enableRow; anchors.centerIn: parent; spacing: 8
                    Text { anchors.verticalCenter: parent.verticalCenter; text: "󰂯"; font.pixelSize: 14; color: "#FFFFFF" }
                    Text { anchors.verticalCenter: parent.verticalCenter; text: "Turn On"; font.pixelSize: 12; font.weight: Font.Medium; color: "#FFFFFF" }
                }
